"""Text-to-speech for the speaking activities: Google Cloud TTS played through pygame."""
...
# The Google service-account key. GOOGLE_APPLICATION_CREDENTIALS (Google's own
# standard variable) overrides it; the old path stays the default, so nothing
# changes for a machine that does not set it.
GOOGLE_CLOUD_JSON = os.getenv(
    "GOOGLE_APPLICATION_CREDENTIALS",
    r"C:\Users\sanad\Downloads\vocatooki-translation-0c42cb154191.json")
