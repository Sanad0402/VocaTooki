...
def test_tc1182_guest_test_guest_guestes_spanish_intermediate_proficiency(altdriver):
    ...
    #   1. Enter the map.
    #   2. ℹ️ Activities were already solved in the Beginning Literacy test for Spanish. Verify levels load correctly.
