...
def test_tc1170_guest_test_guest_guestde_german_intermediate_proficiency(altdriver):
    ...
    #   1. Enter the map.
    #   2. ℹ️ Activities were already solved in the Beginning Literacy test for German. Verify levels load correctly.
