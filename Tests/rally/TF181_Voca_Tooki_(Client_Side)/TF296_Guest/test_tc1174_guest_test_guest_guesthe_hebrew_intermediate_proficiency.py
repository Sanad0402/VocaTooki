...
def test_tc1174_guest_test_guest_guesthe_hebrew_intermediate_proficiency(altdriver):
    ...
    #   1. Enter the map.
    #   2. ℹ️ Activities were already solved in the Beginning Literacy test for Hebrew. Verify levels load correctly.
