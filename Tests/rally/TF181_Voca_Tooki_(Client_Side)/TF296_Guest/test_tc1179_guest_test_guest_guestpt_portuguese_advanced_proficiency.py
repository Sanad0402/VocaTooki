...
LAST_NAME = "guest6thPo"
# What this case picks on the onboarding option screens, in any order.
OPTIONS = ["Portuguese", "Advanced Proficiency", "Female"]
...
def test_tc1179_guest_test_guest_guestpt_portuguese_advanced_proficiency(altdriver):
