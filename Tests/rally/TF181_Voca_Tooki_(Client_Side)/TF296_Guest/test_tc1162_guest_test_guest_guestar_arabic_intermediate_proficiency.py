...
def test_tc1162_guest_test_guest_guestar_arabic_intermediate_proficiency(altdriver):
    ...
    #   1. Enter the map.
    #   2. ℹ️ Activities were already solved in the Beginning Literacy test for Arabic. Verify levels load correctly.
