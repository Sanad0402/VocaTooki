...
LAST_NAME = "guest4thPo"
# What this case picks on the onboarding option screens, in any order.
OPTIONS = ["Portuguese", "Elementary Proficiency", "Female"]
...
def test_tc1177_guest_test_guest_guestpt_portuguese_elementary_proficiency(altdriver):
    ...
    assert result["ok"], (
        ...
        f"Expected: - Guest registration completes successfully with correct name and language. - Difficulty 'Elementary Proficiency' is correctly applied. - Avatar gender 'Female' is selected and displayed correctly. -...")
    ...
    #    the map and complete it"). This case is a 'Elementary Proficiency'
